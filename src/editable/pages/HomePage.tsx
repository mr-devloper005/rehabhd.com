...
export default async function HomePage() {
  const primaryTaskConfig = SITE_CONFIG.tasks.find((task) => task.enabled && !isUiHiddenTask(task.key))
  const primaryTask = (primaryTaskConfig?.key || 'sbm') as TaskKey
  ...
  return (
    <EditableSiteShell>
      <main>
        ...
        <div className="mx-auto w-full max-w-[var(--editable-container)] px-5 pb-4 pt-2 sm:px-8 lg:px-10">
